/**
 * TWAPOrderHook Contract ABI
 * Auto-generated from Foundry build artifacts
 * Source: contracts/src/hooks/TWAPOrderHook.sol
 */
export const TWAP_ORDER_HOOK_ABI = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct TWAPOrderHook.TWAPOrder",
        "components": [
          {
            "name": "owner",
            "type": "address",
          ...
          },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum TWAPOrderHook.OrderStatus"
          }
        ]
      }
    ],
  ...
  {
    "type": "error",
    "name": "InvalidNumberOfExecutions",
    "inputs": []
  },
  {
    "type": "error",
