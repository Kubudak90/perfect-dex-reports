/**
 * AutoCompoundHook Contract ABI
 * Auto-generated from Foundry build artifacts
 * Source: contracts/src/hooks/AutoCompoundHook.sol
 */
export const AUTO_COMPOUND_HOOK_ABI = [
  {
    "type": "constructor",
    "inputs": [
      {
  ...
  {
    "type": "function",
    "name": "DEFAULT_MIN_COMPOUND_INTERVAL",
    "inputs": [],
    "outputs": [
      {
        "name": "",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct AutoCompoundHook.PoolConfig",
        "components": [
          {
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct AutoCompoundHook.Position",
        "components": [
          {
            "name": "owner",
            "type": "address",
          ...
          {
            "name": "fees0Accumulated",
            "type": "uint256",
            "internalType": "uint256"
          },
          {
            "name": "fees1Accumulated",
            "type": "uint256",
            "internalType": "uint256"
          },
          {
  ...
  {
    "type": "error",
    "name": "CompoundTooSoon",
    "inputs": []
  },
  {
    "type": "error",
    "name": "CompoundingDisabled",
    "inputs": []
  },
  {
    "type": "error",
